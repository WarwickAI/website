  ...
  if (!submissionOpen) {
    return defaultPage(
      <div>
        ...
        <ChessDemo
          title={randomFile.replaceAll("_", " ").replace(".fen", "")}
          fenData={fenData}
          tileSize="3vw"
        />
        <BackButton />
    ...
    <>
      ...
      <div className="justify-self-center">
        <p className="max-w-3xl pb-4 text-center font-mono text-lg text-wai-gray md:text-xl">
          ...
          <br />
          <br />
          Your challenge is to create a chess AI, which will go head-to-head
          against other submissions in a best of 3 matchup! To enter, read the
          guidelines below and submit your python submission file. Submissions
          by the top 3 contestants will be awarded prizes!
          <br />
          <br />
          Good luck!
        </p>
      ...
      <div className="w-full max-w-3xl justify-self-center rounded-lg border-4 border-blue-green bg-pure-white p-4 font-mono text-xl font-bold text-wai-gray shadow-sm shadow-wai-gray md:w-fit">
        Submissions are now open! The competition will end on {"{TBD}"}. With
        results being announced on codenight the day after.
      </div>
    ...
    <div className="grid grid-cols-1 place-content-center gap-12 p-1 pb-8">
      <div className="w-full max-w-3xl justify-self-center rounded-lg border-4 border-wai-gray bg-pure-white p-4 font-mono text-xl font-bold text-wai-gray shadow-sm shadow-wai-gray md:w-fit">
        ...
        <p className="pb-4">
          <br />
          <br />
          Big sorry. This area is under construction. Tight time constraints
          mean that corners are cut... :P
          <br />
          <br />
          Also the stuff below won't work -- In progress of making it all
          seemless ;)
        </p>
