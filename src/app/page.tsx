    ...
    defaultPage(
      <div>
        ...
        >
          <div
            id="logo-with-links"
            className="grid grid-cols-1 place-content-center justify-self-center h-fit"
          >
          ...
          <div className="h-fit w-7/8 grid grid-cols-1 place-items-center justify-self-center text-black md:place-content-center lg:w-3/4">
            <ListCalendar
              events={events}
              enableLocation={true}
              enableLinks={true}
