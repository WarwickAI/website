...
export default async function Home() {
      ...
      event: [
        {
          ...
          title: "Intro to AI",
          description:
            "A formal description of AI and introduction to types of AI. Includes a tour of commonly used machine learning techniques.",
      ...
      event: [
        {
          ...
          description:
            "A short self-contained course on how to create AI art using ready-made diffusion models. No programming knowledge required.",
      ...
      event: [
        {
          ...
          description:
            "Learn how to prototype and build Neural Networks quickly to get started solving problems with AI. Neural Networks are immensely powerful and have been shown to be sufficient for the majority of problems.",
      ...
      event: [
        {
          ...
          title: "Practical AI",
          description:
            "Learn how to structure AI problems and choose the right tools for the job. How to source and prepare datasets to aid your solutions.",
      ...
      event: [
        {
          ...
          description:
            "Machine Learning and pattern recognition in all its glory. Covers numerous ML methods for prediction, feature extraction and feature reduction.",
      ...
      event: [
        {
          ...
          description:
            "Learn how to extract features from images for use in AI image-based applications. Discover specialised image processing models for computer vision based problems.",
      ...
      event: [
        {
          ...
          description:
            "What is reinforcement learning, how can I use it and when? Learn how to build cooperative and adversarial agents for use in complex learning environments.",
  ...
  return defaultPage(
    <div>
      <div>
        <h1 className="pt-16 text-center text-5xl font-bold">Courses</h1>
        <h2 className="text-center text-xl font-bold">
          Here are the FREE courses we are running! We hope to see you there!
        </h2>
      </div>

      <div className="mx-auto grid max-w-screen-xl grid-cols-1 place-content-center gap-16 p-3 pb-12 lg:grid-cols-[60%_40%] lg:p-4">
        <div className="m-auto grid h-fit grid-cols-1 box-no-padding p-2 md:p-4">
                ...
                <>
                  ...
                  {index < events.length - 1 && (
                    <div className="my-4 flex w-full justify-center">
                      <div className="h-1 w-11/12 rounded-full bg-wai-gray opacity-30 md:w-10/12"></div>
                    </div>
                  )}
                </>
              ))}
