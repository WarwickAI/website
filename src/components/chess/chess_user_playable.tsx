...
export default function ChessBoardPlayable() {
  ...
  async function getMoveFromAPI(fen: string): Promise {
  ...
  return (
    <>
      {winner && (
        <div className="text-center text-4xl font-bold text-blue-green">
      ...
      />
      <p className="text-center text-2xl font-bold">{currentBoardFEN}</p>
    </>
  );
}
