...
export default function ChessDemo(props: { title: string, fenData: string, tileSize?: string }) {
    ...
    return (
        <div>
            <ChessBoard fenString={currentFen ?? "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"} tileSize={props.tileSize} />
            <p className={"t-16 text-center font-mono text-lg text-wai-gray"}>{currentFen ? props.title : "Loading..."}</p>
        </div >
    );
};
