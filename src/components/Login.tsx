  ...
  return (
    <div className="grid gap-2">
      <div className="space-y-2">
        <h3 className="leading-none font-medium">Sign in</h3>
        <p className="text-muted-foreground text-sm">
          Choose how to log into your WAI account
        </p>
      </div>
